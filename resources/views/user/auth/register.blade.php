                    ...
                    <div>
                      <div class="flex">
                        <div class="inset-y-0 left-0 flex items-center pointer-events-none">
                          <img src="/images/person-icon.svg" alt="my-icon" class="mr-3 mt-5 h-5 w-5 text-gray-400"/>
                        </div>
                        <input id="name" class="border-x-0 border-t-0 focus:ring-0 pb-1 pl-0 mt-5 block w-full text-sm" placeholder="Username" type="text" name="name" value="{{ old('name') }}" required autofocus />
                      </div>
                    </div>
                    <div>
                      <div class="flex">

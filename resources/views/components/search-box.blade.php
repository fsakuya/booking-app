<form method="POST" action="{{route('user.list.search')}}" class="md:w-1/2 ms:w-full flex p-2 bg-white rounded border-solid border-gray-500 shadow-2">
    @csrf
    ...
    <input id="shop_name" name="shop_name" type="text" placeholder="Search..." class=" pl-2 border-0 p-0 text-xs w-3/5 input input-bordered max-w-xs" />
  </form>